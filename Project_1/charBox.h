...
//A class conting the char variables name and cryptName, an int variable to count the occurance of the char, and a float variable rewq to store the frequencey of the occuring character.
class charBox
{
private:
	int count;
